...
## Agentic Workflow — ドキュメンテーションの自動更新
Duration: 20
...
> aside positive
>
> **Agentic Workflow の可能性**: ドキュメント更新以外にも、テストの自動生成、コードレビューの自動化、リリースノートの作成、バグの自動検知と修正提案など、様々なタスクを Agentic Workflow として構築できます。
...
4. **Agentic Workflow** — GitHub Actions と Copilot を組み合わせたドキュメント自動更新
